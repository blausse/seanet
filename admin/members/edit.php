...
//쿼리 작성
    ...
    //비밀번호를 입력한 경우
        ...
        $sql .= " where idx = '$g_idx';";
//     //비밀번호를 입력하지 않은 경우
        $sql_nPwd = "update members set mobile='$mobile',email='$email',birth='$birth',addr_b='$addr_b',addr_d='$addr_d',pscode='$pscode',gender='$gender' where idx = '$g_idx';";
// //db에 쿼리 전송
...
alert('수정되었습니다.');
location.href = 'http://localhost/web_project/admin/members/list.php';
</script>";
?>
