...
.modify{border:none;background:#0080ff;color:white;padding: 5px 10px;border-radius:15px;margin-right:10px;}
.delete{border:none;background:#0080ff;color:white;padding: 5px 10px;border-radius:15px;}
    </style>
</head>
<body>
    ...
    <p class="total">전체 <?php echo $total;?>개</p>
        ...
        ?>
            ...
            <div class="sidebox">
        <button class="write"><a href="write.php">글쓰기</a></button>
        <button class="modify"><a href="modify.php?n_idx=<?php echo $array["idx"];?>">수정</a></button>
        <button class="delete"><a href="#" onclick="notice_del(<?php echo $array['idx'];?>)">삭제</a></button>
        </div>
