...
<head>
    ...
    <script src="../script/postalcode.js"></script>
        ...
        <header>
            <div class="logo_header_wrap">
                <div class="logo_header">
                    <h1><a href="index.html" class="header_logo">SEANET</a></h1>
            ...
            <div class="top_menu">
                <div class="top_menu_wrap">
                    ...
                    <button href="#" class="login">로그인</button>
                    <button href="#" class="signup">회원가입</button>
                    <button href="#" class="signup">마이페이지</button>
                    <button href="#" class="signup">고객센터</button>
                ...
                <fieldset class="signup_box">
                    ...
                    <div class="u_info1">
                        ...
                        <p>
                            ...
                            <label for="sub_addr">참고항목<input type="text" name="sub_addr" id="sub_addr"></label>
