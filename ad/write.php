...
<head>
    ...
    <link rel="stylesheet" href="../css/ad_write.css" type="text/css">
...
$(title).eq(0).css({color:"#0080ff",background:"#fff"})
...
for(i = 0; i < 6; i++){
var ai_items = $('.ai_item').eq(i);
var titles = $('.ai_item_title button').eq(i);
var ai = ai_items.find($('input:checkbox')).is(":checked");
console.log(ai);
if(ai == true){
    titles.css({color:"#fff",background:"#0080ff"});
}
};
});
})
        ...
        <main>
                <form action="insert.php" name="provision_list.form" method="post" enctype="multipart/form-data" onsubmit="return regCheck()">
                    <fieldset class="reg_wrap">
                        ...
                        <label for="c_info">사업 내용</label><span class="err_text"></span>
                        <span class="text_box"><input type="text" name="c_info" id="c_info"></span>
                        <label for="c_logo_name" class="c_logo">회사 로고</label>
                        <div class="filebox">
                        ...
                        <div class="filebox">
                            <input name="c_logo_name" class="upload-name" value="이미지 크기 : 233 * 175 pixels"
                        ...
                        <label for="c_logo_name" class="c_logo">메인 배너 로고</label>
                        <div class="filebox" id="filebox">
                            <input name="c_logo_name" class="upload-name" value="이미지 크기 : 1200 * 440 pixels"
